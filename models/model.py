...
class MobileBlock(nn.Module):
    def __init__(self, in_c, out_c, stride, expand=6):
        ...
        self.block += [
            nn.Conv2d(mid_c, mid_c, 3, stride=stride, padding=1, bias=False),
            nn.BatchNorm2d(mid_c),
            nn.ReLU(True),
...
class FirstStageNet(nn.Module):
    def __init__(self):
        ...
        self.feature = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(True),
            MobileBlock(32, 16, 1, 1),
            *make_block(16, 24, 2, 2),
            *make_block(24, 32, 3, 2),
            *make_block(32, 64, 4, 2),
            *make_block(64, 96, 3, 2),
